...
- **v0.2.1 (2026-09-02)** — implementation fix only: gradient references on container elements (`<g fill="url(#g)">`) no longer crash the encoder. No format change; no byte of the container is affected.
